...
export default function HomeScreen() {
  ...
  const pickFromGallery = async () => {
    ...
    setStatusMessage('Photo added. Optionally name it below, then tap Get recipe.');
  };
  ...
  const pickFromCamera = async () => {
    ...
    setPendingImage({ base64: asset.base64, mimeType: asset.mimeType ?? 'image/jpeg' });
    setStatusMessage('Photo captured. Optionally name it below, then tap Get recipe.');
  };
          ...
          {pendingImage ? (
            <>
              ...
              <View style={styles.photoPrompt}>
                <ThemedText style={styles.photoPromptTitle}>What’s in the photo? (optional)</ThemedText>
                <View style={[styles.inputShell, styles.inputShellCompact]}>
                  <TextInput
                    placeholder="e.g. rigatoni with peas and tomato"
                    placeholderTextColor={colors.textTertiary}
                    value={dishName}
                    onChangeText={setDishName}
                    style={[styles.mainInput, { fontSize: isSmall ? 15 : 16 }]}
                ...
                <TextInput
                  ...
                  style={[styles.detailsInputCompact, { fontSize: isSmall ? 14 : 15 }]}
                  multiline
                  numberOfLines={3}
